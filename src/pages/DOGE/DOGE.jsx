  ...
  // const {img} = props;
	return(
      ...
      <Box  sx={{maxWidth: '400px', m: '0px auto'}}>
        <Card grill="Dogechain" poolBalance={contractBalance} walletBalance={walletBalance} steak={steak} reward={reward}
        ...
        <div className="Link">
          <div style={{padding:'12px 24px'}}>
            ...
            <div className="Link_font2">
              Earn 5% of the DOGE used to grill steak from anyone who uses your referral link
            </div>
          </div>
        </div>
        <div className="Icon">
