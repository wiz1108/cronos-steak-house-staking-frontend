...
const Page = (props) => {
  ...
  const [chefs, setChefs] = useState(0);
	...
	const steakContract = useSelector((state) => {
		return state.user.lionSteak;
	});

  const tokenContract = useSelector((state) => {
    return state.user.lion;
  })
  ...
  // const {img} = props;
	return(
      ...
      <Card grill="LION" poolBalance={contractBalance} walletBalance={walletBalance} steak={steak} reward={reward} chefs={chefs}
        ...
        <div className="Fact">
          <div style={{padding: '12px 24px'}}>
            ...
            <div className="m_between" style={{marginTop:'20px'}}>
              ...
              <div className="Fact_font2">up to 3%</div>
            </div>
            ...
            <div className="m_between">
              <div className="Fact_font2">Token burn</div>
              <div className="Fact_font2">5%</div>
            </div>
            <div className="m_between">
              <div className="Fact_font2">APR</div>
              <div className="Fact_font2">1,095%</div>
            </div>
          </div>
        </div>
        <div className="Link">
          <div style={{padding:'12px 24px'}}>
            ...
            <div className="Link_font2">
              Earn 3% of the LION used to grill steak from anyone who uses your referral link
            </div>
          </div>
        </div>
        <div className="Icon">
					<Link to='https://cronoscan.com/address/0x9C81D5475B5cC89EdFBD9C0d095a7f9b99B5eAC0' target="_blank"><img src="./1.png" alt='address'/></Link>
